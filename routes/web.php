...
// "ogni volta che chiamo la url prodotto/qualcosa, quel qualcosa viene salvato in automatico nella variabile id, quella function è una callback"
Route::get('/product/{idProdotto}', function ($id) {
    // Ho creato all'interno della cartella config il file pasta.php. Con questa riga lo richamo
    // Questi sono file che possono essere richiamati ovunque nel sito
    $data = config('pasta');
